...
<head>
<title>SignUp</title>
<link rel="stylesheet" type="text/css" href="captcha-code-generator/style.css" />
<script type="text/javascript" src="captcha-code-generator/js/jquery-1.6.min.js"></script>
<script type="text/javascript" src="captcha-code-generator/js/captcha.js"></script>
  ...
  ?>
	...
	<?php
		...
		require 'captcha-code-generator/includes/rand.php';
	...
	<form  name="signup" id="signupform" method="post">
		...
		<tr>
    			<td><div id="captchaimage"><a href="" id="refreshimg"  title="Another image"><img src="captcha-code-generator/captcha/image.php?<?php echo time(); ?>" alt="Captcha image" width="132" height="46" align="left" /></a></div><p class="signUpText">[Click on image to refresh]</p></td>
    			<td></td>
  		</tr>
		</table> 
